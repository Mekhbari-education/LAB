...
import { ArrowLeft, Dna, Construction } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-screen bg-surface rtl font-sans" dir="rtl">
      <div className="flex items-center gap-4 px-6 py-4 border-b border-outline/10 bg-surface/80 backdrop-blur-md sticky top-0">
        ...
        <div>
          <h1 className="text-xl font-bold bg-gradient-to-l from-cyan-500 to-blue-400 bg-clip-text text-transparent flex items-center gap-2">
            <Dna size={24} className="text-cyan-500" />
            عارض الجزيئات 3D
          </h1>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-surface-container-lowest">
         ...
         >
           ...
           <div className="w-24 h-24 bg-cyan-100 text-cyan-500 rounded-full flex items-center justify-center mb-8 relative">
              <Dna size={48} />
           ...
           <p className="text-on-surface-variant leading-relaxed mb-8">
             عارض ومُصمم ثلاثي الأبعاد للجزيئات الكيميائية سيُضاف قريباً لتوضيح التفاعلات والروابط الفراغية!
           </p>
