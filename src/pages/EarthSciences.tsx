...
export default function EarthSciences() {
  ...
  return (
    <div className="flex flex-col h-screen bg-surface rtl font-sans" dir="rtl">
      <div className="flex items-center gap-4 px-6 py-4 border-b border-outline/10 bg-surface/80 backdrop-blur-md sticky top-0">
        ...
        <div>
          <h1 className="text-xl font-bold bg-gradient-to-l from-amber-600 to-orange-400 bg-clip-text text-transparent flex items-center gap-2">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-surface-container-lowest">
         ...
         >
           ...
           <div className="w-24 h-24 bg-amber-100 text-amber-600 rounded-full flex items-center justify-center mb-8 relative">
              <Globe size={48} />
           ...
           <p className="text-on-surface-variant leading-relaxed mb-8">
             تطوير محاكاة تفاعلية للظواهر الجيولوجية، الزلازل، البراكين، وطبقات الأرض. ستكون متاحة قريباً!
           </p>
