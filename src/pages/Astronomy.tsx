...
import { ArrowLeft, Telescope, Construction } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-screen bg-surface rtl font-sans" dir="rtl">
      <div className="flex items-center gap-4 px-6 py-4 border-b border-outline/10 bg-surface/80 backdrop-blur-md sticky top-0">
        ...
        <div>
          <h1 className="text-xl font-bold bg-gradient-to-l from-fuchsia-500 to-pink-400 bg-clip-text text-transparent flex items-center gap-2">
            <Telescope size={24} className="text-fuchsia-500" />
            الفضاء وعلم الفلك
          </h1>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-surface-container-lowest">
         ...
         >
           ...
           <div className="w-24 h-24 bg-fuchsia-100 text-fuchsia-500 rounded-full flex items-center justify-center mb-8 relative">
              <Telescope size={48} />
           ...
           <p className="text-on-surface-variant leading-relaxed mb-8">
             وحدة تفاعلية لاستكشاف المجموعة الشمسية وحركة الأجرام السماوية ستكون متاحة قريباً.
           </p>
