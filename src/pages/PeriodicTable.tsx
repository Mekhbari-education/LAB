            ...
            >
              ...
              <div className="flex-1 p-12 overflow-y-auto custom-scrollbar bg-surface text-right">
                ...
                <div className="space-y-8">
                  ...
                  <div className="pt-8">
                     <button 
                       onClick={() => window.open(`https://www.google.com/search?q=${selectedElement.name}+atom+3d+model`, '_blank')}
                       className="w-full py-4 bg-primary text-on-primary rounded-2xl font-black flex items-center justify-center gap-2 hover:brightness-110 transition-all shadow-xl shadow-primary/20">
                        <Maximize2 size={20} />
