...
const Atom3D = React.lazy(() => import('./pages/Atom3D'));
const VirtualLab = React.lazy(() => import('./pages/VirtualLab'));
const WorksheetGenerator = React.lazy(() => import('./pages/WorksheetGenerator'));
const Exao = React.lazy(() => import('./pages/Exao'));
const PhysicsSimulations = React.lazy(() => import('./pages/PhysicsSimulations'));
const VirtualMicroscope = React.lazy(() => import('./pages/VirtualMicroscope'));
const ScientificCalculator = React.lazy(() => import('./pages/ScientificCalculator'));
const MolecularViewer = React.lazy(() => import('./pages/MolecularViewer'));
const Astronomy = React.lazy(() => import('./pages/Astronomy'));
const EarthSciences = React.lazy(() => import('./pages/EarthSciences'));
const Anatomy = React.lazy(() => import('./pages/Anatomy'));
          ...
          <Router>
            ...
            <Suspense fallback={
              ...
              {(!user || setupComplete) ? (
                ...
                <Route path={ROUTES.ATOM_3D.substring(1)} element={<Atom3D />} />
                <Route path={ROUTES.VIRTUAL_LAB.substring(1)} element={<VirtualLab />} />
                <Route path={ROUTES.WORKSHEET_GENERATOR.substring(1)} element={<WorksheetGenerator />} />
                <Route path={ROUTES.EXAO.substring(1)} element={<Exao />} />
                <Route path={ROUTES.PHYSICS_SIMULATIONS.substring(1)} element={<PhysicsSimulations />} />
                <Route path={ROUTES.VIRTUAL_MICROSCOPE.substring(1)} element={<VirtualMicroscope />} />
                <Route path={ROUTES.SCIENTIFIC_CALCULATOR.substring(1)} element={<ScientificCalculator />} />
                <Route path={ROUTES.MOLECULAR_VIEWER.substring(1)} element={<MolecularViewer />} />
                <Route path={ROUTES.ASTRONOMY.substring(1)} element={<Astronomy />} />
                <Route path={ROUTES.EARTH_SCIENCES.substring(1)} element={<EarthSciences />} />
                <Route path={ROUTES.ANATOMY.substring(1)} element={<Anatomy />} />
